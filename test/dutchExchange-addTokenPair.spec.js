...
const {
  ...
  timestamp,
  gasLogger
} = require('@gnosis.pm/dx-contracts/test/utils')

const { getContracts, setupTest, getClearingTime, getAuctionIndex } = require('@gnosis.pm/dx-contracts/test/testFunctions')
